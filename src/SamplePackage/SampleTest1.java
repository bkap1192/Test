...
public void testParameterWithXML2() throws InterruptedException
{
	 ...
	 System.out.println("Executing testParameterWithXML2 : " + Thread.currentThread().getName());
...
public void testParameterWithXML3() throws InterruptedException
{
	 ...
	 System.out.println("Executing testParameterWithXML3 : " + Thread.currentThread().getName());
    driver.get("http://demo.guru99.com/V4/");
